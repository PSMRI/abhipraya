...
<body><header class="docs-head"><a href="/">Abhipraya</a><nav><a href="/developer.php">Developer hub</a> · <a href="/admin/login">Administrator sign in</a></nav></header><div class="docs-layout"><aside class="docs-sidebar" aria-label="Documentation index"><p class="docs-sidebar-title">Documentation</p><a class="<?= $key === 'README' ? 'is-active' : '' ?>" href="/docs/README.md">About Abhipraya</a><a class="<?= $key === 'user-guide' ? 'is-active' : '' ?>" href="/docs/user-guide.md">User guide</a><a class="<?= $key === 'developer-guide' ? 'is-active' : '' ?>" href="/docs/developer-guide.md">Developer guide</a><a class="<?= $key === 'security' ? 'is-active' : '' ?>" href="/docs/security.md">Security guide</a><a class="<?= $key === 'dpg-readiness' ? 'is-active' : '' ?>" href="/docs/dpg-readiness.md">Open source &amp; DPG</a><p class="docs-sidebar-title docs-sidebar-group">Resources</p><a href="/developer.php">Architecture hub</a><a href="/CONTRIBUTING.md">Contributing</a><a href="/SECURITY.md">Report a vulnerability</a></aside><main class="docs-main"><article class="docs-content"><?= docsRender($markdown) ?></article></main></div></body></html>
