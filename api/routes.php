...
return [
    'GET' => [
        ...
        '/v1/social-audit/resolve' => $module('social-audit', 'resolve'),
    ...
    'POST' => [
        ...
        '/v1/social-audit/generate' => $module('social-audit', 'generate'),
        '/v1/social-audit/submit' => $module('social-audit', 'submit'),
        '/v1/capa/actions' => $module('capa', 'actions'),
