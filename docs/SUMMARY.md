...
- [Abhipraya documentation](README.md)
...
- [Technology architecture and tools](architecture/technology_architecture.md)
...
- [Kafka and event-driven architecture](architecture/event_driven_architecture.md)
- [Configuration JSON formats](architecture/configuration_formats.md)
- [Coding standards and conventions](architecture/coding_standards.md)
...
- [Administrator and service-location user provisioning](user_provisioning.md)
...
- [OpenAPI and Postman](api/openapi_postman.md)
- [OpenAPI specification (rendered)](openapi-reference.md)
- [Postman collection (rendered)](postman-collection-reference.md)
...
- [Deployment bootstrap scripts](deployment/deployment_bootstrap_scripts.md)
...
- [Troubleshooting and FAQ](deployment/troubleshooting_faq.md)

## Testing

- [Test plan](testing/test_plan.md)
- [White-box and black-box testing](testing/white_box_black_box_testing.md)
- [Functional and non-functional testing](testing/functional_non_functional_testing.md)
- [Test results](testing/test_results.md)
- [Passed-test evidence register](testing/test_evidence_register.md)
- [VAPT test report](testing/vapt_test_report.md)
- [Performance test results](testing/performance_test_results.md)
- [WCAG and web platform compliance](testing/wcag_web_platform_compliance.md)
...
- [GPL-3.0-or-later licence](compliance/license.md)
- [Notice](compliance/notice.md)
- [Security policy](compliance/security-policy.md)
- [Code of Conduct](compliance/code-of-conduct.md)
- [Contributing](compliance/contributing.md)
- [Maintainers and release contacts](compliance/maintainers.md)
- [Licence consistency before and after release](compliance/license_consistency_before_after.md)
- [Third-party licences](compliance/third_party_licenses.md)
- [Privacy and data protection](compliance/privacy_data_protection.md)
- [Content safeguarding and moderation](compliance/content_safeguarding.md)
...
- [Data redistribution approval](compliance/data_redistribution_approval.md)
...
- [Third-party notices](compliance/third-party-notices.md)
- [GitBook and HTML publishing](gitbook.md)
